...
import Cara1 from '../assets/Sermon1.jpeg'

function Main() {
    return (
        <div className="carousel carousel-center max-w-md p-4 space-x-4 bg-base-300 shadow-2xl rounded-box">
            <div className="carousel-item">
                <div className="card w-96 h-96 bg-base-100 shadow-2xl">
                    <figure className="px-10 pt-10">
                        <img src={Cara1} alt="Shoes" className="h-52 rounded-xl" />
                    </figure>
                    <div className="card-body items-center text-center">
                        <h2 className="card-title">Tune into The Talk Show!</h2>
